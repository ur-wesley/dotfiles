...
#   $f="$env:TEMP\install.ps1"; irm https://raw.githubusercontent.com/<owner>/<repo>/main/install/install.ps1 -OutFile $f; [IO.File]::WriteAllText($f,(Get-Content $f -Raw).Replace("`n","`r`n")); & $f
#
